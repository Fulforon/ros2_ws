...
class AWNavigationNode(Node):
    ...
    def __init__(self):
        ...
        self.goal_poses.append({'x': 3774.09, 'y': 73800.96, 'z': 0.23, 'w': 0.97})
        self.goal_poses.append({'x': 3734.12, 'y': 73729.92, 'z': 0.20, 'w': 0.97})
        self.goal_poses.append({'x': 3891.12, 'y': 73815.03, 'z': -0.54, 'w': 0.83})
        self.goal_poses.append({'x': 3675.97, 'y': 73769.48, 'z': 0.46, 'w': 0.88})
